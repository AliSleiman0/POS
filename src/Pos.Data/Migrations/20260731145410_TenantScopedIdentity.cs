...
{
    /// <inheritdoc />
    public partial class TenantScopedIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_application_role_name_length", "length(\"name\") <= 64");
                    table.CheckConstraint("ck_application_role_normalized_name_length", "length(\"normalized_name\") <= 64");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_application_user_display_name_length", "length(\"display_name\") <= 100");
                    table.CheckConstraint("ck_application_user_email_length", "length(\"email\") <= 256");
                    table.CheckConstraint("ck_application_user_normalized_email_length", "length(\"normalized_email\") <= 256");
                    table.CheckConstraint("ck_application_user_normalized_user_name_length", "length(\"normalized_user_name\") <= 256");
                    table.CheckConstraint("ck_application_user_user_name_length", "length(\"user_name\") <= 256");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_user_role_application_role_role_id",
                        column: x => x.role_id,
                        principalTable: "application_role",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ux_application_user_tenant_normalized_email",
                table: "application_user",
                columns: new[] { "tenant_id", "normalized_email" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ux_application_user_tenant_normalized_user_name",
                table: "application_user",
